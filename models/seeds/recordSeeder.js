...
db.once('open', () => {
  Record.create(
    ...
    { name: '午餐', category: '餐飲食品', date: '2021-01-04', amount: 80, merchant: 'OO牛肉麵', categoryIcon: '<i class="fas fa-utensils"></i>' },
    { name: '電話費', category: '其他', date: '2021-01-05', amount: 600, merchant: 'XX電信', categoryIcon: '<i class="fas fa-pen"></i>' }
  ).then(() => {
