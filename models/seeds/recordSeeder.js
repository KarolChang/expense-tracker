...
db.once('open', () => {
  Record.create(
    ...
    { name: '電話費', category: '其他', date: '2021-02-05', amount: 700, merchant: 'XX電信', categoryIcon: '<i class="fas fa-pen"></i>' },
    { name: '午餐', category: '餐飲食品', date: '2021-02-05', amount: 100, merchant: '排骨飯', categoryIcon: '<i class="fas fa-utensils"></i>' }
  ).then(() => {
